...
include_once("/twitter_src/inc/twitteroauth.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php
	if(isset($_SESSION['status']) && $_SESSION['status'] == 'verified') 
	{
		...
		echo '<a href="'.$base_url.'twitter_src/process.php"><img src="'.$base_url.'images/sign-in-with-twitter.png" width="151" height="24" border="0" /></a>';
	}
?>  
</body>
</html>