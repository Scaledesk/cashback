        ...
        <div class="reset">
          ...
          <form method="post" id="track-order" action="#" accept-charset="UTF-8">
            <div class=" form-group">
              ...
              <input type="text" class="form-control" value="" name="" id="order-id" placeholder="Category Title" required="">
            </div>
            <div class=" form-group">
              <label class="sr-only" for="billing-mail">Category Description</label>
              <textarea class="form-control" rows="5" cols="40" placeholder="Category Description" name="" id="" required=""></textarea>
            </div>
